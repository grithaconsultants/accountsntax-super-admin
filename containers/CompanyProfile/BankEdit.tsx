...
const BankEdit = (props: any) => {
  ...
  const initialValues: any = {
    _id: modalBool?._id,
    bankName: modalBool?.bankName,
    accountNo: modalBool?.accountNo,
    ifscCode: modalBool?.ifscCode,
    typeOfAccount: modalBool?.typeOfAccount,
    beniFiciaryName: modalBool?.beniFiciaryName,
  }
  ...
  async function callAsync(formValues: any) {
    ...
    let orgBanks = company.bankDetail;
    let clonedArr = [...orgBanks];
    ...
    console.log(TAG, ' updated bank ', clonedArr);
  ...
  return (
    ...
    >
      <div className="modal-wrapper" >
        <div className="m-tlt" >
          <div className="m-tlt-sec" >Edit Bank Details</div>
              ...
              <div className="customer-modal-body mt-3" >
                <div className="gx-3 row gy-2" >
                  ...
                  <div className="col-lg-4 col-12 " >
                    <SimpleSelectLabel
                      option={accountType}
                      selected={accountType[accountType.findIndex((x: any) => x.value === values?.typeOfAccount)]}
                  ...
                  <div className="col-lg-4 col-12 " >
                    <CustomInput
                      ...
                      type="text"
                      disabled={loading}
                      defaultValue={values?.beniFiciaryName}
                      maxLength={1000}

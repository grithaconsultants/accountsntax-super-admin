          ...
          <div className="col-xl-9 col-lg-9 col-md-12 col-12" >
            ...
            {otpStatus === false ?
              ...
              <>
                ...
                <div className="pt-2 a-title-sub" >We’ve sent the OTP at {userData?.email} <span className='d-none' onClick={backToState} >Change</span> </div>
